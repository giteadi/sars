...
export const registerUser = createAsyncThunk(
  ...
  async (userData, { rejectWithValue, dispatch }) => {
    try {
      const response = await axios.post('https://api.sarsdecor.com/api/v1/user/register', userData);
...
export const loginUser = createAsyncThunk(
  ...
  async (userData, { rejectWithValue }) => {
    try {
      const response = await axios.post('https://api.sarsdecor.com/api/v1/user/login', userData);
...
export const verifyOTP = createAsyncThunk(
  ...
  async ({ email, otp }, { rejectWithValue }) => {
    try {
      const response = await axios.post('https://api.sarsdecor.com/api/v1/user/verify-otp', { email, otp });
